...
if __name__ == "__main__":
    ...
    # run_once(name='', data=loaded_data,
    #          params=get_simul_params(activation=SIGMOID, alpha=0.02, batch_size=100, draw_range=0.2,
    #                                  hidden_neurones=50, worse_result_limit=2, momentum_param=0))

    # run_simulation(name='alpha2', data=loaded_data, repeats=2,
    ...
    #     run_simulation(name='batch4', data=loaded_data, repeats=5,
    ...
    for momentum in [1.0]:
        run_simulation(name='momentum2', data=loaded_data, repeats=5,
                       params=get_simul_params(activation=SIGMOID, alpha=0.02, batch_size=100, draw_range=0.2,
                                               hidden_neurones=50, worse_result_limit=2, momentum_param=momentum))
